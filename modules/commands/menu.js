...
module.exports.run = async function({ api, event, args }) {
	...
	const fs = require('fs-extra');
	const imgP = []
	const img = [" https://giphy.com/gifs/one-piece-YWB6Hi29vA3jG", " https://giphy.com/gifs/film-z-1195W96ZIyUra8", " https://giphy.com/gifs/one-piece-opgraphics-roronoa-zoro-jO3guf6Wf47T2", " https://giphy.com/gifs/one-piece-zoro-roronoa-c16VBx4QeNq9i", " https://giphy.com/gifs/one-piece-luffy-2enbvOorwd2Io", " https://giphy.com/gifs/funimation-one-piece-y4Vpu2AeAEEh2", " https://giphy.com/gifs/one-piece-luffy-wQroBvfZkusM0", " https://giphy.com/gifs/TOEIAnimationUK-one-piece-kaido-ZBnqbhjQrm4M5bB9k", " https://giphy.com/gifs/one-piece-roronoa-zoro-QQUEsHquYDjEY", " https://giphy.com/gifs/one-piece-rCdzKS756yiGs", "https://i.imgur.com/hrJJLu3.gif"]
	var path = __dirname + "/cache/menu.gif"
	var rdimg = img[Math.floor(Math.random() * img.length)]; 
