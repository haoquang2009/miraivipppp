...
module.exports.languages = {
	"vi": {
		...
		"betsLow": "Bạn phải đặt cược tối thi��u là 1000$",
...
module.exports.run = async ({ api, event, args, Users, Currencies, getText }) => {
	...
	switch (args[0]) {
		...
		default: {
        const picture = (await axios.get(`https://imgur.com/meDmvW1.png`, { responseType: "stream"})).data
      return api.sendMessage({body: " ",attachment: (picture)
